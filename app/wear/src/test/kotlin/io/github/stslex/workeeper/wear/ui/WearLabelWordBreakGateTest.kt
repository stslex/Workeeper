...
/**
 * Gate G10, English half — no button label breaks inside a word. Both locales are needed
...
internal class WearLabelWordBreakGateTest {

    @Test
    @DisplayName("no English rendered text splits a word, on both screens at both font scales")
