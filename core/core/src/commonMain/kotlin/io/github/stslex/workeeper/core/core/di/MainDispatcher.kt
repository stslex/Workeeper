...
/**
 * DI qualifier for the MainDispatcher seam. Modeled as an `expect annotation class` so consumers
 * import it unchanged from `core.core.di`; the Android actual carries
 ...
 */
expect annotation class MainDispatcher()
