...
import io.github.stslex.workeeper.core.ui.kit.resources.core_ui_kit_tag_create_format
import io.github.stslex.workeeper.core.ui.kit.resources.core_ui_kit_tag_done
import io.github.stslex.workeeper.core.ui.kit.resources.core_ui_kit_tag_search_hint
import io.github.stslex.workeeper.core.ui.kit.resources.core_ui_kit_tag_sheet_title
...
fun AppTagPickerSheetContent(
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        Text(
            text = stringResource(Res.string.core_ui_kit_tag_sheet_title),
        ...
        AppTextField(
            ...
            placeholder = stringResource(Res.string.core_ui_kit_tag_search_hint),
        ...
        if (canCreate) {
            AppSheetItem(
                ...
                title = stringResource(Res.string.core_ui_kit_tag_create_format, normalizedQuery),
        ...
        AppButton.Primary(
            ...
            text = stringResource(Res.string.core_ui_kit_tag_done),
            onClick = onDone,
        )
    }
}
