...
/**
 * `@SingleIn(AppScope)` gives this app-scoped holder a process-lifetime single-owner; the class-level
 * `@Inject` makes it constructor-injectable by the graph.
 *
 ...
 * accessor, which pulls this scoped `@Inject` class into the graph as a self-bound singleton.
 */
