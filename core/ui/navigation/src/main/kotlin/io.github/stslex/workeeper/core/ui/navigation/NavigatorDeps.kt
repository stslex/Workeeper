 ...
 *
 * Part of the god-object split (variant A, spine variant γ). Kept separate from
 ...
 * verbatim from the app graph's accessor set so `AppGraph`'s existing override satisfies it with no
 * new provision.
 *
