# Skill update — `compose-state-discipline.md`

This is a **new skill** to drop into `.claude/skills/compose-state-discipline.md`. It captures four
rules that apply project-wide. Rules 1–3 emerged from the v2.1 PR review; Rule 4 was validated in
the `fix/navigation-lifecycle-problems` work and pulls dialogs/sheets out of `Event` so they survive
