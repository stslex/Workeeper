...
#
# COVERAGE: N = 1..13 are all committed — the arc is fully ported and wired into SERIES below, so one run produces the whole
...
exercise-chart|b3ef0480
exercise|0f129261
single-training|8f2fb43b
live-workout|ee959370
app-dialogs|5fafe040
...
# The N column is this series' integrity check. It must ASCEND 1,2,3,4,5,6,7,7,8,9,10,11,12,13,13 — the repeats are
...
echo
echo "Reading it:"
echo "  * FIRST check the N column ascends 1,2,3,4,5,6,7,7,8,9,10,11,12,13,13. Identical values mean every row measured"
