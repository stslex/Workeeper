 ...
 *
 * None of it existed on this screen: `loadState.append` was never read, so a failed page was a list
 * that quietly stopped. The navnote names this screen explicitly — "Пагинация уже есть в
 * тренировках, упражнениях и архиве" — so the tails are contract here, not a borrowed treatment.
 *
...
internal fun PagingLoadingFooter(
    ...
    Row(
        modifier = modifier
            ...
            .testTag("AllExercisesPagingLoading"),
        ...
        Text(
            text = stringResource(R.string.feature_all_exercises_paging_loading),
...
internal fun PagingErrorFooter(
    ...
    Row(
        modifier = modifier
            ...
            .testTag("AllExercisesPagingError"),
        horizontalArrangement = Arrangement.spacedBy(AppDimension.Space.md),
        verticalAlignment = Alignment.CenterVertically,
    ) {
        Text(
            modifier = Modifier.weight(1f),
            text = stringResource(R.string.feature_all_exercises_paging_error),
        ...
        AppButton.Tertiary(
            modifier = Modifier.testTag("AllExercisesPagingRetry"),
            text = stringResource(R.string.feature_all_exercises_paging_retry),
