...
internal fun BulkActionBar(
    ...
    Row(
        modifier = modifier
            ...
            .testTag("AllTrainingsBulkActionBar"),
        ...
        AppButton.Secondary(
            modifier = Modifier
                .weight(1f)
                .testTag("AllTrainingsBulkArchive"),
            text = stringResource(R.string.feature_all_trainings_bulk_archive),
            onClick = onArchive,
        ...
        AppButton.Destructive(
            modifier = Modifier
                .weight(1f)
                .testTag("AllTrainingsBulkDelete"),
            text = stringResource(R.string.feature_all_trainings_bulk_delete),
            onClick = onDelete,
            enabled = canDelete,
            size = AppButtonSize.MEDIUM,
        )
