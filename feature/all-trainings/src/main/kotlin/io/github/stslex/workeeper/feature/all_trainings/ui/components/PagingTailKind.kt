 ...
 *
 * Measured, not assumed: found on the sibling screen and measured there — with the branch inlined in the screen's
 * `LazyListScope` block, deleting the `LoadState.Error` case left every golden byte-identical.
 * Both screens had it; both close it the same way. The footers themselves are
