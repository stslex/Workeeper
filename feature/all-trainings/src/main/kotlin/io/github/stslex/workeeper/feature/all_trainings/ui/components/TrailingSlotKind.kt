 ...
 *
 * Duplicated from `all-exercises` rather than shared, following `PagingTailKind`: the two screens
 * draw one skeleton (§26 "List row") but are separate modules, and §27's MATCH rule wants a test
 * on **each** side of a behavioural parity claim rather than one test and an assertion of sameness.
 */
