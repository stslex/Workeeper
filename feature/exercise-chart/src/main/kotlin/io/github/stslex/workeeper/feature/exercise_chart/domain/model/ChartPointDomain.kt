...
/**
 * One plotted completed session. Under the per-set metrics the point is a concrete set and
 * `weight`/`reps` are that set's. Under `ChartMetricDomain.VOLUME_PER_SESSION` the point is a session
