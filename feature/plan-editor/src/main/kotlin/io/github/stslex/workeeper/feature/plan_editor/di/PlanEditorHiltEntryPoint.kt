...
/**
 * Hilt→Metro bridge for feature/plan-editor (KMP C.1 wave 3). Pulls the 8 app-scoped `@Singleton`
 * dependencies out of the Hilt `SingletonComponent` for [PlanEditorGraph] as `@Provides` bound
 * instances. `@DefaultDispatcher` stays QUALIFIED (`includeJavax`), the only dispatcher. No Context.
 */
@EntryPoint
@InstallIn(SingletonComponent::class)
internal interface PlanEditorHiltEntryPoint {
