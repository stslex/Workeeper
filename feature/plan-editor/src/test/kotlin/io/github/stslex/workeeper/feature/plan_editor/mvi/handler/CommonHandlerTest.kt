...
internal class CommonHandlerTest {
    ...
    /**
     * The store mock runs `launchDefault` synchronously and routes a throw to `onError` — that
     * routing is the thing under test, since the production default for `onError` is `{}`.
     */
