...
/**
 * Every arm pinned explicitly, both directions — the settings side of the same gate
 * `feature/home`'s mapper test holds: a swapped arm would persist a different mode than the
 * row the user tapped, and the handler tests do not execute the coroutine that maps.
 */
